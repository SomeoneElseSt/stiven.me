...
In hindsight, it's a very intuitive conclusion, as the count of events in each column of the coin sample space matches the sum of the **N**th row in Pascal's triangle. 
