...
const en: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'I am a runner, techno‑optimist, and effective altruist/accelerationist. Currently thinking about social prediction in Hyderabad.',
        blogHeader: 'Blog',
        linksHeader: 'Links',
...
const es: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'Soy corredor, tecnooptimista y altruista eficaz/aceleracionista. Ahora pienso en predicción social en Hyderabad.',
        blogHeader: 'Blog',
        linksHeader: 'Enlaces',
...
const ja: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'ランナーで、テクノオプティミスト、そして効果的利他主義／アクセラレーショニストです。現在はハイデラバードでの社会的予測について考えています。',
        blogHeader: 'ブログ',
        linksHeader: 'リンク',
...
const hi: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'मैं धावक, तकनीक‑आशावादी, और प्रभावी उदारवादी/त्वरणवादी हूँ। अभी हैदराबाद में सामाजिक पूर्वानुमान के बारे में सोच रहा हूँ।',
        blogHeader: 'ब्लॉग',
        linksHeader: 'लिंक',
...
const de: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'Ich laufe gern, bin Techno‑Optimist und effektiver Altruist/Accelerationist. Gerade denke ich über soziale Vorhersage in Hyderabad nach.',
        blogHeader: 'Blog',
        linksHeader: 'Links',
...
const fr: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'Je suis coureur, techno‑optimiste et altruiste efficace/accélérationniste. Je réfléchis en ce moment à la prédiction sociale à Hyderabad.',
        blogHeader: 'Blog',
        linksHeader: 'Liens',
...
const ko: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: '러너이며 테크노 옵티미스트이고 효과적 이타주의/가속주의 성향입니다. 지금은 하이데라바드에서의 사회적 예측을 생각하고 있습니다.',
        blogHeader: '블로그',
        linksHeader: '링크',
...
const pt: LocaleDefinition = {
    ...
    messages: {
        ...
        bio4: 'Sou corredor, techno‑otimista e altruísta eficaz/aceleracionista. Neste momento penso em predição social em Hyderabad.',
        blogHeader: 'Blog',
        linksHeader: 'Links',
